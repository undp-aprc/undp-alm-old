 ...
 */
?>
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix cca-content-box highlight-1"<?php print $attributes; ?>>
    <div class="node-content-left">
        <?php if($content['field_thumbnail']): ?>
            <?php print(render($content['field_thumbnail'])); ?>
        <?php endif; ?>
    </div>
    <div class="node-content-right<?php print $content_attributes; ?>">
